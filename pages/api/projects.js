const projects = {
  en: [
    {
      id: "pasante-admission",
      name: "Módulo de Insolvencia - Pasante de Admisión",
      date: "2021",
      status: "PRODUCTION",
      description: [
        "In my early days working with Nuvu for the government (Superintendency of Companies), we developed a very particular microfrontend.",
        '"Pasante de Admisión" was an application powered by machine learning for automatic validation of insolvency applications, it has streamlined hundreds of procedures that previously took weeks and even months.',
        "It was a project full of challenges, from the design of its modular architecture, its document generation tools in the browser until my participation as Technical Leader / FullStack Developer in project's last months.",
      ],
      thumbnail: {
        src_1x:
          "/assets/projects/pasante_admision/pasante_admision_cover_thumbnail_1x.jpg",
        src_2x:
          "/assets/projects/pasante_admision/pasante_admision_cover_thumbnail_2x.jpg",
      },
      cover: "/assets/projects/pasante_admision/pasante_admision_cover.jpg",
      url: "https://mi.ia.supersociedades.gov.co/WebData/inicio/0.pub",
    },
    {
      id: "avengers-web",
    ...
    },
    {
      ...
      behance:
        "https://www.behance.net/gallery/102931097/CambiaBits-BTC-Mobile-App",
    },
    {
      id: "fny-ecommerce",
      ...
      thumbnail: {
        src_1x:
          "/assets/projects/ecommerce_fny/ecommerce_fny_cover_thumbnail_1x.jpg",
        src_2x:
          "/assets/projects/ecommerce_fny/ecommerce_fny_cover_thumbnail_2x.jpg",
      },
    ...
    },
    {
      ...
      thumbnail: {
        src_1x:
          "/assets/projects/space_drop_it/space_drop_it_cover_thumbnail_1x.jpg",
        src_2x:
          "/assets/projects/space_drop_it/space_drop_it_cover_thumbnail_2x.jpg",
      },
    ...
    },
    {
      ...
      thumbnail: {
        src_1x:
          "/assets/projects/terybit_app/terybit_app_cover_thumbnail_1x.jpg",
        src_2x:
          "/assets/projects/terybit_app/terybit_app_cover_thumbnail_2x.jpg",
      },
      ...
      behance:
        "https://www.behance.net/gallery/105746911/Tery-Bit-BTC-Videogame",
    },
  ],
  es: [
    {
      ...
      status: "PRODUCTION",
      description: [
        "En mis inicios trabajando con Nuvu para el gobierno (Superintendencia de Sociedades), desarrollamos un microfrontend bastante particular.",
        "El pasante de admisión era una aplicación potenciada por machine learning para validación automática de solicitudes de insolvencia, ha agilizado cientos de trámites que antes tardaban semanas e incluso meses.",
        "Fué un proyecto lleno de retos, desde el diseño de su arquitectura modular, sus herramientas de generación de documentos en el navegador y posteriormente mi participación como Lider técnico / FullStack Developer en los últimos meses del proyecto.",
      ],
      thumbnail: {
        src_1x:
          "/assets/projects/pasante_admision/pasante_admision_cover_thumbnail_1x.jpg",
